...
public class FavAdapter extends RecyclerView.Adapter<FavAdapter.myVH> {
    ...
    public FavAdapter(Context context,Activity ctx, ArrayList<String> itemList, int parentLayout, int eachItem) {
    ...
    @NonNull
    @Override
    public FavAdapter.myVH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v= LayoutInflater.from(context).inflate(parentLayout,viewGroup,false);
        return new FavAdapter.myVH(v);
    }

    @Override
    public void onBindViewHolder(@NonNull FavAdapter.myVH myVH, int i) {
        Glide.with(context)
